...
public class ZcashPresentationPanel extends ZcashJPanel {
	private Color  colorBorder = ZcashXUI.presentationpanelBorder;
	private Color  backGroundColor    = ZcashXUI.presentationpanel;
	static final int GRADIENT_EXTENT = 17;

	static final Stroke edgeStroke  = new BasicStroke(1);

	public ZcashPresentationPanel() {

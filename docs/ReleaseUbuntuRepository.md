## [Bitzec Swing Wallet](https://swing.bitzec.com/) APT repository for Debian/Ubuntu Linux

## ATTENTION - Bitzec is NOT available via package repositry YET. Work in Progress. Please download signed .deb package directly from releases or from https://swing.bitzec.com

Bitzec Swing Wallet is also available via package repository for Debian/Ubuntu (and similar) Linux systems.

![Screenshot](bitzec.png "Main Window")
...
### Installing the Bitzec Swing Wallet on Linux
*Zcash is needed to be installed, follow https://z.cash/download.html prior to installing this Bitzec Swing wallet.*
...
sudo apt-get update
sudo apt-get install bitzec
```
   
### Running the Bitzec Swing Wallet on Linux

To launch the Bitzec Swing Wallet you can just search and click on it in the Ubuntu unity menu or alternatively, run the command `bitzec` from a terminal:
```
bitzec
```

...
```
Linux:    ~/.MyZcash/MyZcashGUIWallet_xxxx_xx_debug.log 
Windows:  %LOCALAPPDATA%/MyZcash/MyZcashGUIWallet_xxxx_xx_debug.log
macOS:   ~/Library/Application Support/MyZcash/MyZcashGUIWallet_xxxx_xx_debug.log
```

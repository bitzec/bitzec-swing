## [Zcash](https://z.cash/) Desktop GUI Wallet known security issues
...
the wallet. In addition users should make sure they are in control of all addresses that are used as receiving addresses for Zcash. If in 
